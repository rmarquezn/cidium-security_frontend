...
export function PostEntry(props) {
  ...
  return (
    <div id="inicio-izq" className="form-group mx-4">
      <div className="font-weight-bold mt-4 mb-4 h1">
        {user.name}, what can you share today?
      </div>

      <label htmlFor="postTitle" className="font-weight-bold h5 mb-2">
        Title:
      </label>
      <input
        type="postTitle"
      ...
      <label htmlFor="postTitle" className="font-weight-bold h5 mt-4 mb-2">
        Post entry:
      </label>
      ...
      <textarea
        ...
        value={postEntry}
        onChange={handlePostEntryChange}
      ></textarea>

      <label htmlFor="postTitle" className="font-weight-bold h5 mb-2 mt-2">
        Autor:
      </label>
      <input
        type="postAutor"
      ...
      <div className="d-flex justify-content-end mt-4">
        <button className="btn btn-dark btn-block" onClick={newPost}>
          POST
        </button>
      </div>
    </div>
